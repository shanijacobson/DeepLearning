...
class SLTModel(nn.Module):
    ...
    def __init__(self, frame_size, gloss_dim, words_dim, word_padding_idx, emo_dim=0, embedding_dim=512, num_layers_encoder=2, num_layers_emo=2,
                 num_layers_decoder=2, n_head=8, ff_size=2048, dropout_encoder=0.1, dropout_decoder=0.1,
                 spatial_flag=False):
        ...
        if emo_dim > 0:
            self.encoder_emo = Encoder(embedding_dim, num_layers_emo, n_head, ff_size, dropout_encoder)
    ...
    def forward(self, frames, words):
        ...
        if self.emo_dim > 0:
            ...
            # TODO: we need to think about the return values of this function
